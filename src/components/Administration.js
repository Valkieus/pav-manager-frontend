...
export default function Administration() {
  ...
  const handleCleanupLogs = async () => {
    ...
    try {
      ...
      toast.success(
        `${res.data.deleted_count} log(s) de plus de 12 mois supprimé(s)`,
      );
      fetchSystemStatus();
    } catch (err) {
                ...
                <form onSubmit={handleUserSubmit} className="space-y-4">
                  ...
                  {!editingUser && (
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        L'utilisateur devra le modifier à la première connexion
                      </p>
                    </div>
                  )}
                  <div className="space-y-2">
                    ...
                    {users
                      ...
                      .map((u) => (
                        <TableRow key={u.id}>
                          ...
                          <TableCell>
                            <Badge
                              className={getNiveauAccesColor(u.niveau_acces)}
                            >
                              {u.niveau_acces}
                            </Badge>
                          </TableCell>
                            ...
                            <div className="flex justify-end gap-1">
                              ...
                              {u.id !== currentUser?.id && (
                                <>
                                  ...
                                  >
                                    <Lock
                                      className={`w-4 h-4 ${u.is_active ? "text-amber-500" : "text-emerald-500"}`}
                                    />
                                  </Button>
                                  <Button
                                    size="sm"
              ...
              <>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Ce qui prend le plus de place, du plus gros au plus petit.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0">
                    <Table>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      ...
                      {systemStatus.last_logs_purge
                        ? systemStatus.last_logs_purge
                        : "jamais"}
                      . Un nettoyage automatique des logs de plus de 12 mois
                      tourne aussi chaque début de mois.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="p-3 rounded-lg border border-border space-y-2">
                      <p className="font-medium text-sm flex items-center gap-2">
                        <Activity className="w-4 h-4" /> Logs (+12 mois)
                      </p>
                      <p className="text-xs text-muted-foreground">
